...
# Les figures sont ecrites a la racine du depot (parent de src/).
...
# ============================================================
S0 = 1.09520
sigma = 2.1e-4  # reference Table 4 du papier ; prix fondamental non simule ici
T = 6.0
M = 10
tick = 1e-5
...
fig1.tight_layout()
fig1.savefig(OUT_DIR / "fig_latence.pdf")
fig1.savefig(OUT_DIR / "fig_latence.png")
...
fig2.tight_layout()
fig2.savefig(OUT_DIR / "fig_phi.pdf")
fig2.savefig(OUT_DIR / "fig_phi.png")
...
fig3.tight_layout()
fig3.savefig(OUT_DIR / "fig_latence_dist.pdf")
fig3.savefig(OUT_DIR / "fig_latence_dist.png")
